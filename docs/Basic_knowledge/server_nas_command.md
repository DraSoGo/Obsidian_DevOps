...
# What
Command reference สำหรับดูแล home server ทั้ง farm — Ubuntu Docker VM (`192.168.1.48`), Proxmox (`192.168.1.47`), TrueNAS (`192.168.1.38`), Tailscale router (`192.168.1.46`) — shell บน VM คือ fish (ghost text + `Ctrl+R` ค้น history แบบ fuzzy) ดูคำสั่งทั่วไปเพิ่มที่ [linux](../Basic_knowledge/linux.md/)
